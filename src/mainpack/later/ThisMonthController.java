...
public class ThisMonthController extends GeneralController {
    @FXML
    private ListView<UsersEvent> monthTasks;
    ...
    protected void initListView() {
        ...
        monthTasks.setItems(todayEvents);
        monthTasks.setCellFactory(CheckBoxListCell.forListView(event -> {
        ...
        monthTasks.getSelectionModel().selectedItemProperty().addListener((observableValue, o, t1) -> {
            try {
                InformationPaneController controller = new InformationPaneController(t1, monthTasks.getSelectionModel().getSelectedIndex());
            ...
            Platform.runLater(() -> monthTasks.getSelectionModel().clearSelection());
        });
    }
